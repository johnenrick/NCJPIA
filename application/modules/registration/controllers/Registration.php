...
class Registration extends FE_Controller{
    //put your code here
    function index(){
        $this->loadPage("registration", array("registration_script", "payment_confirmation_script", "form_initialization_script", "submit_registration_script"), array("message" => false));
